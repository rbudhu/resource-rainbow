"""
Django settings for resource_rainbow project.
...
SECRET_KEY = '+rz^i2_&=2yaco)iek3zd_2q#)cw=p$jf%%m#d*wn!+mf7n(6b'
...
WSGI_APPLICATION = 'resource_rainbow.wsgi.application'
